package com.mcworkshop.wehcm.constant;

/**
 * Created by markfredchen on 6/30/15.
 */
public interface WeHCMConstants {
    String EMAIL_CONFIG_EMAIL_ADDRESS = "emailAddress";
    String EMAIL_CONFIG_PROTOCOL_TYPE = "protocol.type";
    String EMAIL_CONFIG_HOST = "host";
    String EMAIL_CONFIG_POST = "port";
    String EMAIL_CONFIG_USER = "user";
    String EMAIL_CONFIG_PASSWORD = "password";
